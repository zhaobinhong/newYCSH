...
$("#bar-chart").dxChart({
    dataSource: [
        {day: "星期一", oranges: 1000},
        {day: "星期二", oranges: 2000},
        {day: "星期三", oranges: 3000},
        {day: "星期四", oranges: 4000},
        {day: "星期五", oranges: 6000},
        {day: "星期六", oranges: 11000},
        {day: "星期日", oranges: 4000} ],
	valueAxis:{
		grid:{
			color: '#9D9EA5',
			width: 0.1
...
$("#pie-chart").dxPieChart({
    dataSource: [
				  { country: "星期一", medals: 10 },
				  { country: "星期二", medals: 20 },
				  { country: "星期三", medals: 30 },
				  { country: "星期四", medals: 40 },
				  { country: "星期五", medals: 60 },
				  { country: "星期六", medals: 110 },
				  { country: "星期日", medals: 40 },
				],
    legend: {
        orient: 'vertical',
        x: 'left',

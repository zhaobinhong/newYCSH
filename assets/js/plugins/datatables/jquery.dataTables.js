...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append('<label class="col-sm-7 control-label">'+str+'</label><div class="col-sm-5">'+input+'</div>'  );	
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		div.append(
			...
			'<label class="col-sm-3 control-label" style="text-align:left;">'+settings.oLanguage.sLengthMenu.replace( '_MENU_', '' )+'</label><div class="col-sm-2">'+select[0].outerHTML+'</div>'
		);
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "显示 _START_ 至 _END_ 的 _TOTAL_ 条",
